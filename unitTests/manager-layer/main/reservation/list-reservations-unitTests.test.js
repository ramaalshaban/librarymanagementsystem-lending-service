...
describe("ListReservations", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/Reservation/list-reservations",
      {
