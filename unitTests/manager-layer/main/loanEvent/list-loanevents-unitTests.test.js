...
describe("ListLoanEvents", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/LoanEvent/list-loanevents",
      {
