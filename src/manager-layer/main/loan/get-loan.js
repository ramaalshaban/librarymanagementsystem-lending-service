...
const { dbGetLoan } = require("dbLayer");

class GetLoanManager extends LoanManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetLoan function to get the loan and return the result to the controller
    const loan = await dbGetLoan(this);
