...
const { dbDeleteReservation } = require("dbLayer");
...
class DeleteReservationManager extends ReservationManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteReservation function to delete the reservation and return the result to the controller
    const reservation = await dbDeleteReservation(this);
