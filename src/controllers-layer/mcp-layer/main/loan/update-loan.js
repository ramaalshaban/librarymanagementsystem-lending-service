...
class UpdateLoanMcpController extends LendingMcpController {
  constructor(params) {
    super("updateLoan", "updateloan", params);
    this.dataName = "loan";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateLoanManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    name: "updateLoan",
    description:
      "Update loan. Used for renewal, return, overdue, and status transitions.",
    parameters: UpdateLoanMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const updateLoanMcpController = new UpdateLoanMcpController(mcpParams);
      try {
        const result = await updateLoanMcpController.processRequest();
        //return UpdateLoanMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
