...
class GetReservationMcpController extends LendingMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const getReservationMcpController = new GetReservationMcpController(
        mcpParams,
      );
      try {
        const result = await getReservationMcpController.processRequest();
