...
console.log("Starting librarymanagementsystem-lending-service service...");
...
const start = async () => {
  process.title = "node-librarymanagementsystem-lending-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-lending-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-lending-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-lending-service is listening HTTP/REST port " +
...
/* starting the server librarymanagementsystem-lending-service .... */
start();
